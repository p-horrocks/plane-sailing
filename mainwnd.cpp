...
QWidget* MainWnd::createRandomBox()
{
    ...
    table->setItem(2, 0, windDirectionMean_);
    table->setItem(2, 1, windDirectionStd_);
    table->setItem(3, 0, planeHeadingMean_);
    table->setItem(3, 1, planeHeadingStd_);
    table->setItem(4, 0, bankRateMean_);
    table->setItem(4, 1, bankRateStd_);
    table->setItem(5, 0, bankAccelMean_);
    table->setItem(5, 1, bankAccelStd_);
